...
public partial class DFDEditor
{
    ...
    {
        // Start/End
        editor.nodes.Add(new Node { Id = 1, Text = "Start", X = 300, Y = 50, Width = 80, Height = 40, Shape = NodeShape.Ellipse, StrokeColor = "#059669", Icon = "play" });
        editor.nodes.Add(new Node { Id = 8, Text = "End", X = 300, Y = 650, Width = 80, Height = 40, Shape = NodeShape.Ellipse, StrokeColor = "#dc2626", Icon = "stop" });
        
        // Process steps
        editor.nodes.Add(new Node { Id = 2, Text = "Display\nLogin Form", X = 270, Y = 120, Width = 140, Height = 60, Shape = NodeShape.Rectangle, StrokeColor = "#3b82f6", Icon = "computer" });
        editor.nodes.Add(new Node { Id = 3, Text = "Enter\nCredentials", X = 270, Y = 210, Width = 140, Height = 60, Shape = NodeShape.Parallelogram, StrokeColor = "#8b5cf6", Icon = "user" });
        editor.nodes.Add(new Node { Id = 4, Text = "Valid?", X = 290, Y = 310, Width = 100, Height = 60, Shape = NodeShape.Diamond, StrokeColor = "#f59e0b", Icon = "key" });
